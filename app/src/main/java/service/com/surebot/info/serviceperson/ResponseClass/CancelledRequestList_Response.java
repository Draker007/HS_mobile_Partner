...
public class CancelledRequestList_Response {

    private  CancelledRequestList_Records [ ] partner_requests_upcoming;

    public CancelledRequestList_Records[] getPartner_requests_upcoming() {
        return partner_requests_upcoming;
    }

    public void setPartner_requests_upcoming(CancelledRequestList_Records[] partner_requests_upcoming) {
        this.partner_requests_upcoming = partner_requests_upcoming;
    }

    public class CancelledRequestList_Records {
