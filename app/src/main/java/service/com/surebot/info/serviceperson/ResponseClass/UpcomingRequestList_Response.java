...
public class UpcomingRequestList_Response {

    private  UpcomingRequestList_Records [] partner_requests_upcoming;

    public UpcomingRequestList_Records[] getPartner_requests_upcoming() {
        return partner_requests_upcoming;
    }

    public void setPartner_requests_upcoming(UpcomingRequestList_Records[] partner_requests_upcoming) {
        this.partner_requests_upcoming = partner_requests_upcoming;
    }

    public class UpcomingRequestList_Records {
